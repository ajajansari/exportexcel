...
var Workbook = require('./methods/workbook')(XLSX);

var formatting = function () {

    var dataArray = require('./dataArray');
    var wb = Workbook;
    var wb = wb.addRowsToSheet("Main", dataArray.dataArray).setFreeze("Main").finalize();
    wb = wb.addRowsToSheet("Main1", dataArray.dataArray).setFreeze("Main").finalize();

    wb = wb.addRowsToSheet("Main123", [
        [{ v: "This is a merged cell This is a merged cell This is a merged cell This is a merged cell", l: { Target: "http://sheetjs.com", Tooltip: "sds" }, "s": { font: { bold: true }, alignment: { wrapText: true } } }],
        [
