...
(function make_xlsx(XLSX) {
    ...
    */
    ...
    var fix_read_opts = fix_opts_func([
        ['cellNF', true], /* emit cell number format string as .z */
        ...
        ['bookDeps', true], /* parse calculation chains */
        ['bookSheets', true], /* only try to get sheet names (no Sheets) */
        ['bookProps', true], /* only try to get properties (no Sheets) */
        ['bookFiles', true], /* include raw file structure (keys, files, cfb) */
        ['bookVBA', true], /* include vba raw data (vbaraw) */
