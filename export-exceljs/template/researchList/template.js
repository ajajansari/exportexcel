...
//This template support DataType for Excel using XLSX,
...
const templateExcelExport = {
    workbookName: `FCSearchResults ${date.toLocaleDateString()}.xlsx`,
    sheets: [{
            name: 'Disclaimer',
            header: {
                logo: {
            ...
            columnWidth: { isCustomize: true, defIdWidth: [{ colId: 1, width: 50 }] },
            logo: {
                url: './export-exceljs/image/Abc_Ratings_logo.png',
                path: 'A1:A1'
            },
            spaceAfterHeader: 2,
            data: [],
        ...
        },
        {
            ...
            columnWidth: { isCustomize: true, defIdWidth: [{ colId: 1, width: 50 }, { colId: 2, width: 20 }, { colId: 3, width: 20 }] },
            rowHeight: { isCustomize: true, defIdHeight: [{ rowId: 1, height: 50 }] },
            logo: {
                url: './export-exceljs/image/Abc_Ratings_logo.png',
                path: 'A1:A1'
